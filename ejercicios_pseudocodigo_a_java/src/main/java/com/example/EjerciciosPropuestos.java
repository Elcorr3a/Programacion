...
/*Actividad de ampliacion 2
Es 36 porque al desplazar los bits de valor 1 en binario 2 veces se queda el numero 36
00001010 =9 -> 01010000 =36
*/
/*Actividad ampliacion 3
Todas las opciones son anteriores son incorrectas ya que al pasar a binario y usar la puerta logica AND
se queda todo en 0
/*Actividad ampliacion 4
b) El valor de (b+1) +13
porque el ++ suma 1 al valor de b
/*Actividad ampliacion 5
Los identificadores validos serian: 1LoveYou, Calcula_fecha, calculaFecha, IVA,
*/